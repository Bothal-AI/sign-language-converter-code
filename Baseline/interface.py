...
class MainWindow:
    def __init__(self, master):
        ...
        master.start.grid(
            row=1, column=0, columnspan=1, padx=70, pady=(50, 5), sticky="nsew"
        )
        master.settings.grid(
            row=2, column=0, columnspan=1, padx=70, pady=5, sticky="nsew"
        )
        master.exit.grid(
...
class SettingsWindow:
    def __init__(self, master):
        ...
        trans_label = ctk.CTkLabel(
            self.top, text="Translation Settings:", font=my_font_label
        )
        overlay_radio = ctk.CTkRadioButton(
            self.top, text="On-Screen Overlay", font=my_font, variable=self.var, value=1
        )
        subtitles_radio = ctk.CTkRadioButton(
            self.top, text="Subtitles Text", font=my_font, variable=self.var, value=2
        )
        ...
        overlay_radio.grid(
            row=1, column=0, columnspan=4, rowspan=1, padx=10, pady=5, sticky="w"
        )
        subtitles_radio.grid(
            row=2, column=0, columnspan=4, rowspan=1, padx=10, pady=5, sticky="w"
        )
        ...
        cancel.grid(
            row=6, column=0, columnspan=2, padx=(10, 5), pady=(5, 10), sticky="nsew"
        )
        save.grid(
            row=6, column=2, columnspan=2, padx=(5, 10), pady=(5, 10), sticky="nsew"
        )
